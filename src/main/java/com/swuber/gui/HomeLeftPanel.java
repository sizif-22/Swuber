...
public class HomeLeftPanel extends JPanel {
    ...
    public HomeLeftPanel(Frame frame, User user) {
        ...
        // User Info
        ImageIcon originalUserIcon = new ImageIcon(HomeLeftPanel.class.getResource("../assets/user.png"));
        ...
        // Exit Button
        ImageIcon originalExitIcon = new ImageIcon(HomeLeftPanel.class.getResource("../assets/Exit-icon.png"));
